...
<html>
  <head>
    <title>${escapeHtml(redirect.title || 'Redirecting...')}</title><link rel="canonical" href="${escapeHtml(redirect.to)}"/><meta name="robots" content="noindex"><meta charset="utf-8"/><meta http-equiv="refresh" content="0; url=${escapeHtml(redirect.to)}"/>
  </head>
</html>
`;
